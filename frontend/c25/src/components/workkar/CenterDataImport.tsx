...
export default function CenterAnalytics({ cardClass, shop }: Props) {
  ...
  const employees: Employee[] = [
    { id: "1", name: "Sarah Johnson", position: "Senior Staff", availability: ["Monday", "Tuesday", "Friday", "Saturday", "Sunday"], currentLoad: 65, skills: ["Customer Service", "Inventory", "Cashier"] },
    { id: "2", name: "Mike Chen", position: "Staff", availability: ["Wednesday", "Thursday", "Friday", "Saturday"], currentLoad: 45, skills: ["Stocking", "Cleaning", "Cashier"] },
    { id: "3", name: "Emily Davis", position: "Senior Staff", availability: ["Monday", "Tuesday", "Thursday", "Sunday"], currentLoad: 70, skills: ["Customer Service", "Training", "Management"] },
    { id: "4", name: "Alex Rodriguez", position: "Staff", availability: ["Friday", "Saturday", "Sunday"], currentLoad: 30, skills: ["Cashier", "Customer Service"] },
    { id: "5", name: "Jessica Wang", position: "Part-time", availability: ["Saturday", "Sunday"], currentLoad: 20, skills: ["Cashier", "Stocking"] },
    { id: "6", name: "David Smith", position: "Staff", availability: ["Monday", "Tuesday", "Wednesday", "Saturday"], currentLoad: 55, skills: ["Inventory", "Cleaning"] },
    { id: "7", name: "Lisa Brown", position: "Part-time", availability: ["Friday", "Saturday"], currentLoad: 15, skills: ["Customer Service"] },
  ];
